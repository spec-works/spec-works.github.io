...
This document defines the conventions and patterns used across all SpecWorks components ("Parts"). These conventions ensure consistency, maintainability, and alignment with the [SpecWorks Factory pattern](factory-spec.md).
